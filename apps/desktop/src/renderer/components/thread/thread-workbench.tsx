...
const MessageAttachments = ({ message }: Readonly<{ message: UserMessage }>) =>
...
const MessageReferences = ({ message }: Readonly<{ message: UserMessage }>) =>
...
const TranscriptMessage = ({
  ...
  if (entry.role === 'agent') {
    return <AgentMessage message={entry.message} />;
  }
