...
export const MAX_CONVERSATION_ATTACHMENT_BASE64_LENGTH =
  4 * Math.ceil(MAX_CONVERSATION_ATTACHMENT_BYTES / 3);
export const MAX_CONVERSATION_VIDEO_BYTES = 2 * 1024 * 1024 * 1024;
