...
import { RuntimeSupervisor } from '@/main/runtime/connection/supervisor';
import { RuntimeModelConfigController } from '@/main/runtime/configuration/model-controller';
import { RuntimeConversationController } from '@/main/runtime/conversation/controller';
import { GoalPowerSaveController } from '@/main/runtime/conversation/goals/power-save-controller';
import { RuntimeConnectionController } from '@/main/runtime/connection/controller';
import { RuntimeApprovalController } from '@/main/runtime/approvals/controller';
import { RuntimeCommandEnvironmentController } from '@/main/runtime/configuration/command-environment-controller';
import { RuntimeGitAdapter } from '@/main/runtime/workspace/git-adapter';
import { RuntimeMcpConfigController } from '@/main/runtime/configuration/mcp-controller';
import { RuntimeMcpApprovalController } from '@/main/runtime/approvals/mcp-controller';
